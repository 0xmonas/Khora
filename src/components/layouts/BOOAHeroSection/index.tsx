...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Create mode generates a brand-new agent identity and portrait from scratch. Import mode lets you bring in an existing ERC-8004 agent from any of 9 chains — AI generates a new pixel art portrait while preserving the original identity. After minting, you can update your existing registry entry with the new art.',
  },
  {
