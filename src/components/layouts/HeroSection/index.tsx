        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-12 sm:col-span-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mt-24">
              {/* Twitter/X Card */}
              <div className="bg-neutral-50 dark:bg-card p-3 lg:p-5 rounded-none hover:scale-105 transition-transform">
                <h3 className="font-mono text-xs lg:text-sm text-foreground text-center">
                  Follow <span className="text-red-500 hover:text-foreground transition-colors cursor-pointer">@khorafun</span> on X for latest update and news
                </h3>
              ...
              <div className="bg-neutral-50 dark:bg-card p-3 lg:p-5 rounded-none hover:scale-105 transition-transform">
                <h3 className="font-mono text-xs lg:text-sm text-foreground text-center">
                  Join <span className="text-red-500 hover:text-foreground transition-colors cursor-pointer">Telegram</span> Community
                </h3>
                <div className="w-10 h-10 lg:w-16 lg:h-16 mx-auto mt-3">
              ...
              <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <Link 
                      href="https://dexscreener.com/solana/BivtZFQ5mVdjMM3DQ8vxzvhKKiVs27fz1YUF8bRFdkKc"
                      target="_blank"
                    ...
                    <Link 
                      href="https://pump.fun/coin/BivtZFQ5mVdjMM3DQ8vxzvhKKiVs27fz1YUF8bRFdkKc"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Image
