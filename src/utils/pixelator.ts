...
const ColorPalettes = {
  DEFAULT: {
    color1: { r: 51, g: 0, b: 255 },    // #3300ff (blue)
    color2: { r: 242, g: 242, b: 242 }  // #f2f2f2 (light gray)
  },
  MONOCHROME: {
    color1: { r: 54, g: 54, b: 54 },    // #171219 (black)
    color2: { r: 236, g: 236, b: 236 }  // #ffffff (white)
  }
} as const;
...
export const pixelateImage = async (
  ...
  const findClosestColor = (color: Color, threshold: number): Color => {
    ...
    return brightness > threshold ? palette.color2 : palette.color1;
  };
