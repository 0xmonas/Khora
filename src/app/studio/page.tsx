...
const TOOLS: ToolCard[] = [
  ...
  {
    id: 'banner-dj-club-studio',
    title: 'Banner & DJ Club Studio',
    description: 'Load wallet, build beats, play pads, MIDI keyboard, record voice, export MP3.',
    href: 'https://booa-studio-bn5b.vercel.app',
    media: 'dj-studio.png',
    external: true,
    creator: '@beastoshii',
    creatorUrl: 'https://x.com/beastoshii',
    github: 'https://github.com/dishant976/booa-studio',
  },
  {
    id: 'moltbooa-lab',
    title: 'Moltbooa Lab',
    description: "Simulate a day on Moltbook. Generate your agent's future. Pixel Comic, Talk to your BOOA, Agent Config Export.",
    href: 'https://moltbooa-lab.vercel.app',
    media: 'moltbooalab.jpeg',
    external: true,
    creator: '@OsayKancuno',
    creatorUrl: 'https://x.com/osaykancuno',
    github: 'https://github.com/osaykancuno/moltbooa-lab',
  },
  {
