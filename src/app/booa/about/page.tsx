...
const CREATE_STEPS = [
  ...
  { num: '02', title: 'Stored on-chain', desc: 'The portrait is encoded as a 2,048-byte bitmap (64x64, C64 palette) and stored via SSTORE2 directly in the contract. Traits are packed into bytes. No IPFS, no external hosting — your agent lives on Ethereum forever.' },
...
const IMPORT_STEPS = [
  ...
  { num: '03', title: 'Mint & update', desc: 'Mint the new portrait on Ethereum in one transaction. Then update your existing ERC-8004 registry entry with the on-chain art via setAgentURI — no new registration needed.' },
];
